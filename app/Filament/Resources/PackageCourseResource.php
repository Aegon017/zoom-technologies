                        ...
                        ->schema([
                            ...
                            Group::make()->schema([
                                ...
                                TextInput::make('user_name')
                                    ->helperText('The name entered will appear on the course completion certificate.')
                                    ->visible(fn(Get $get): bool => ! $get('is_registered'))->required()->label('Student Name'),
                            ...
                            Select::make('packageSchedule_id')
                                ...
                                ->options(function ($get) {
                                    if ($get('package_id')) {
                                        ...
                                        $schedules = Schedule::where('status', true)->whereIn('course_id', $courseIds)->orderBy('course_id', 'asc')->orderBy('start_date', 'asc')->orderBy('time', 'asc')->get()->pluck('formatted_package_schedule', 'id');
