...
class BankTransferPolicy
{
    ...
    {
        return $user->can('view_any_bank::transfer');
    }
    ...
    {
        return $user->can('view_bank::transfer');
    }
    ...
    {
        return $user->can('create_bank::transfer');
    }
    ...
    {
        return $user->can('update_bank::transfer');
    }
    ...
    {
        return $user->can('delete_bank::transfer');
    }
    ...
    {
        return $user->can('delete_any_bank::transfer');
    }
