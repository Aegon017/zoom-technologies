...
class ContactLocationPolicy
{
    ...
    {
        return $user->can('view_any_contact::location');
    }
    ...
    {
        return $user->can('create_contact::location');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, ContactLocation $contactLocation): bool
    {
        return $user->can('update_contact::location');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, ContactLocation $contactLocation): bool
    {
        return $user->can('delete_contact::location');
    }
    ...
    {
        return $user->can('delete_any_contact::location');
    }
