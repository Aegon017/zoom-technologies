...
class QRCodePolicy
{
    ...
    {
        return $user->can('view_any_q::r::code');
    }
    ...
    {
        return $user->can('create_q::r::code');
    }
    ...
    {
        return $user->can('update_q::r::code');
    }
    ...
    {
        return $user->can('delete_q::r::code');
    }
    ...
    {
        return $user->can('delete_any_q::r::code');
    }
     ...
     */
    public function replicate(User $user, QRCode $qRCode): bool
    {
