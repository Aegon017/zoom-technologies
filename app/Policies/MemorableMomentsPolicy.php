...
class MemorableMomentsPolicy
{
    ...
    {
        return $user->can('view_any_memorable::moments');
    }
    ...
    {
        return $user->can('create_memorable::moments');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, MemorableMoments $memorableMoments): bool
    {
        return $user->can('update_memorable::moments');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, MemorableMoments $memorableMoments): bool
    {
        return $user->can('delete_memorable::moments');
    }
    ...
    {
        return $user->can('delete_any_memorable::moments');
    }
