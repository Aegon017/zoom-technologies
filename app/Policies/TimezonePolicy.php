...
class TimezonePolicy
{
    ...
    {
        return $user->can('view_any_timezone');
    }
    ...
    {
        return $user->can('create_timezone');
    }
    ...
    {
        return $user->can('update_timezone');
    }
    ...
    {
        return $user->can('delete_timezone');
    }
    ...
    {
        return $user->can('delete_any_timezone');
    }
