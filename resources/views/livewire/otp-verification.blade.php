<div>
    ...
    <div x-data="{ otpInput: false, addressBtnContinue: false }" x-on:verification-success.window="addressBtnContinue=true">
        <button class="btn btn-dark" x-on:click="$dispatch('send-otp'); otpInput = !otpInput" x-transition.duration
            x-show="! otpInput">Send
            Verification
            Mail</button>
        <div x-transition.duration x-show="otpInput">
            ...
            <form wire:submit="verifyOTP">
                ...
                <div class="d-flex justify-content-between ml-2 mt-4">
                    ...
                    <button class="btn btn-orange" x-transition.duration x-show="addressBtnContinue"
