<div class="row">
    ...
    <div class="col-xl-6 col-md-12 wow fadeInLeft" data-wow-delay="100ms">
        <div class="news-one__single bg-white">
            <div class="news-one__img-box">
                <div class="news-one__img">
                    <img src="{{ asset(Storage::url($newsItem['thumbnail'])) }}"
                        alt="{{ $newsItem['thumbnail_alt'] ?? 'News Thumbnail' }}">
                </div>
            </div>
                ...
                <div class="news-one__person-and-date">
                    ...
                    <div class="news-one__date">
                        <p>
                            ...
                            {{
                            \Carbon\Carbon::parse($newsItem['created_at'])->format('F j, Y')
                            }}
                        </p>
                    </div>
                </div>
