<x-form-section submit="updateAddress">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="address" type="text" class="mt-1 block w-full" wire:model="faddress" required
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="zip_code" type="text" class="mt-1 block w-full" wire:model="zip_code" required
